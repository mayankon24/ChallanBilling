...
namespace Billing.DataLayer
{
    class CompanyDL
    {
        public bool Insert(CompanyEL objCompanyEL)
        {
            ...
            try
            {
                int Id = objSQLHelper.ExecuteInsertProcedure("InsertCompany", objSqlTransaction
                                                         , objSQLHelper.SqlParam("@Company_Type_Id", objCompanyEL.Company_Type_Id, SqlDbType.Int)
        ...
        public List<CompanyEL> GetCompanyListByType(int CompanyTypeId)
        {
            ...
            if (dt != null)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    objCompanyEL.Company_Type_Id = CompanyTypeId;
