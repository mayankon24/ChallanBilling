...
namespace PurchasesChallan
{
    public partial class PackagingDetail : Form
    {
        ...
        public PackagingDetail(int deliveryDetailId, string compnayName, string itemName): this()
        {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dataGridView1.Rows.Count > 0)
                {
                    ...
                    objPackagingDetailDL.Update(objSqlTransaction, this.DeliveryDetailId, dt);
        ...
        void GridBind()
        {
            ...
            {
                PackagingDetailDL objPackagingDetailDL = new PackagingDetailDL();
                DataTable dt = objPackagingDetailDL.GetPackingDetail(this.DeliveryDetailId);
